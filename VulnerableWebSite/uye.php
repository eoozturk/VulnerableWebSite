...
<div class="container-fluid" role="main" >
	<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
					...
					<li>'OR 'x'='x </li>
	<div class="wrapper">
		<form action="uye.php" method="post" name="Login_Form" class="form-signin">       	  
			  <input type="text" class="form-control"  name="name" placeholder="Username" required="" autofocus="" />
			  <input type="password" class="form-control"  name="pass" placeholder="Password" required=""/>     		  
			  <button class="btn btn-lg btn-primary btn-block" name="gonder" value="Login" type="Submit">Kullanıcıları Listele</button>  			
		</form>		
	</div>
<?php
