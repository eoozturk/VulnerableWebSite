  ...
  <div class="row">
    <div class="col-md-4 col-md-offset-4">
	  ...
	  <div class="duyurubaslik">
		<span><h3>ZAYIF (VULNERABLE) WEB UYGULAMALARI</h3></span>
		</div>
		</div>
	  </div>
  </div>
...
Zayıf Web Uygulaması (ZWU) kasıtlı olarak bırakılmış güvenlik zafiyetleri içeren PHP/MySQL web uygulamasıdır. Kasıtlı olarak bırakılmış güvenlik zafiyetlerini (vulnerability) içeren zayıf (vulnerable), web uygulamaları, uygulamalı siber güvenlik eğitimlerinde önemli bir rol oynamaktadır. Oğrenciler, yasal olmayan bir şekilde gerçek sistemlere saldırmadan bu tip uygulamalar üzerinde öğrendiklerini tecrübe ederek kendilerini gelistirebilmektedirer.
<br><br>
Farklı programlama dillerinde (PHP, ASP, CH.NET, Nodejs, PERL, Java, Ruby on Rails, Python, C++, Cold Fusion vb.) yazılmış vulnerable web uygulamaları bulunmaktadır. Fakat, Türkçe yazılmış ve iyi bir şekilde dokümantasyonu yapılmış vulnerable web uygulamaları yok denecek kadar azdır
<br><br>
